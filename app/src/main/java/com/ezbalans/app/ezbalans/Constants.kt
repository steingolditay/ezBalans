...
object Constants {
    ...
    @JvmField val room_category_family = arrayListOf<String>(category_rent, category_bills, category_repairs, category_groceries, category_clothing, category_medical,
    ...
    val room_category_roommates = arrayListOf<String>(category_rent, category_bills, category_repairs, category_groceries, category_pet, category_internet,
                                                                    category_tv, category_other)

    val room_category_couple = arrayListOf<String>(category_rent, category_bills, category_repairs, category_groceries, category_medical, category_gifts, category_entertainment, category_alcohol,
    ...
    val room_category_vacation = arrayListOf<String>(category_rent, category_groceries, category_medical, category_entertainment, category_alcohol, category_tobacco, category_gas,
